          ...
          <b-col lg="3">
            <b-card :title="(model.id ? 'Edit Post ID#' + model.id : 'New Post')">
              <form @submit.prevent="savePost">
                <b-form-group label="Area (Experience, Education, Professional Development)">
                  <b-form-input type="text" v-model="model.area"></b-form-input>
                </b-form-group>
                ...
                <b-form-group label="Year">
                  <b-form-input type="text" v-model="model.year"></b-form-input>
                </b-form-group>
                <div>
